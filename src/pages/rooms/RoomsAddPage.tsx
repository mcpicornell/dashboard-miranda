  ...
  return (
    <FormUserContainer onSubmit={onSubmitHandler}>
      <OptionsContainer>
        ...
        <InputCreateUser
          required
          placeholder="type the url of the room photo"
        ...
        <OptionsContainer>
          <CheckBoxContainer>
            <CheckBox
              ...
              value="Shower"
              onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                setAmenitiesShower(e.target.value)
              }
            />
          ...
          <CheckBoxContainer>
            <CheckBox
              type="checkbox"
              value="Bath"
              onChange={(e) => setAmenitiesBath(e.target.value)}
            />
          ...
          <CheckBoxContainer>
            <CheckBox
              type="checkbox"
              value="TV"
              onChange={(e) => setAmenitiesTV(e.target.value)}
            />
          ...
          <CheckBoxContainer>
            <CheckBox
              type="checkbox"
              value="Sea Views"
              onChange={(e) => setAmenitiesSeaViews(e.target.value)}
            />
          ...
          <CheckBoxContainer>
            <CheckBox
              ...
              onChange={(e) => setAmenitiesTowels(e.target.value)}
            />
            <CheckBoxOption>Air-conditioning system</CheckBoxOption>
          </CheckBoxContainer>
          ...
          <CheckBoxContainer>
            <CheckBox
              type="checkbox"
              value="WiFi"
              onChange={(e) => setAmenitiesWiFi(e.target.value)}
            />
      ...
      <OptionsContainer>
        ...
        <InputCreateUser
          type="number"
          required
          placeholder="type the original price"
      ...
      <OptionsContainer>
        ...
        <InputCreateUser
          ...
          max={100}
          required
          placeholder="type the percentage of discount"
